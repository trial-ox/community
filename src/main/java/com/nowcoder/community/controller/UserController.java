...
public class UserController implements CommunityConstant {
    ...
    public String updatePwd(String old_Pwd, String new_Pwd, Model model) {
        User user = hostHolder.getUser();
        String old = CommunityUtil.md5(old_Pwd + user.getSalt());
        if (old.equals(user.getPassword())) {
            String newPwd = CommunityUtil.md5(new_Pwd + user.getSalt());
